...
parser.add_argument('--lr_client', type=float, default=0.002)
...
if config['dataset'] == 'Bili_Food':
    config.update({
        'num_users': 6549,
        'num_items_train': 13584,
        'num_items_vali': 2378,
        'num_items_test': 2378,
        'content_dim': 768,
    })
elif config['dataset'] == 'CiteULike':
    config.update({
        'num_users': 5551,
        'num_items_train': 13584,
        'num_items_vali': 1018,
...
vali_data = data_dict['valid_data']
...
vali_item_img_features = data_dict['valid_img_features']
vali_item_text_features = data_dict['valid_text_features']
